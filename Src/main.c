...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, USB_PWR_Pin|USB_DISCN_Pin|CAN_TERM_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USB_DISCN_Pin CAN_TERM_Pin */
  GPIO_InitStruct.Pin = USB_DISCN_Pin|CAN_TERM_Pin;
